...
const AddComment: React.FC<{ questionData: QuestionProp | null }> = ({ questionData }) => {
  ...
  const { addAnswerModal } = useSelector((states: RootState) => states.globalStates)
  ...
  return (
    ...
    bg-black bg-opacity-50 transform z-50 transition-transform duration-300 ${addAnswerModal}`}
    >
